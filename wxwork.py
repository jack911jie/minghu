...
class WeComRobot:
    ...
    def send_data(self,cus_name='MH016徐颖丽',crs_type='常规私教课',crs_date='20220527',crs_time='1000-1100',ins='MHINS001陆伟杰'):
        ...
        self.send(txt_to_send=txt_to_send,ins_name=ins_name,ins_tel=ins_tel)

    def send(self,txt_to_send,ins_name,ins_tel):
        print(txt_to_send,'\n',ins_name,'\n',ins_tel,'\n')            
        ...
        ins_data={
            "msgtype": "text",
            "text": {
                "content": ins_name+'教练，'+'您的会员约课信息如下：',
                # "mentioned_list":["wangqing","@all"],
...
class Notification:
    ...
    def send_body_note(self,cus_name='MH010苏云',crs_types=['常规私教课','初级团课'],nowtime='20220804',ins_name='MHINS001陆伟杰'):
        ...
        rbt.send(txt_to_send=txt_to_send,ins_name=ins_real_name,ins_tel=ins_tel)
...
if __name__=='__main__':
    ...
    res=p.send_body_note(cus_name='MH003吕雅颖',crs_types=['常规私教课','限时私教课','初级团课'],nowtime='20220804')
    # print(res)
